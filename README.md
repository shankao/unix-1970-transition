...
defines the core-only execution and RAM layout using the completed bare KA11
contract. The current `as11` encoder is a validated bootstrap nucleus, not the
final specification of the assembler.
